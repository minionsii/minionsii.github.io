...
<?php
$catIDdiaphuong = $_REQUEST['catIDdiaphuong'];
...
WHERE san_pham.DP_ID = '$catIDdiaphuong' AND hinh_anh_sp.HA_MAT_DINH = 1 AND ((san_pham.TT_ID = 1) or (san_pham.TT_ID = 2))
";
			...
			<div class="left-side">
				...
				<ul>
					...
					while ($row_kqsqldiaphuong = mysqli_fetch_array($kqsqldiaphuong)) {
						if ($rowsqlshowdiachi['DP_TEN'] == $row_kqsqldiaphuong['DP_TEN']) {
							

							?>	
							<li>
								<a href="indexdiaphuong.php?catIDdiaphuong=<?php echo $row_kqsqldiaphuong['DP_ID']?>">
									<input type="checkbox" class="checked" value="" checked="">
